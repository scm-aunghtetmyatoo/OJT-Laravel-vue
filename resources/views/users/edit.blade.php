                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update',$user->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="address" id="address" cols="30" rows="5" class="form-control @error('dob') is-invalid @enderror">{{ $user->address }}</textarea>
                        ...
                        <div class="form-group row">
                            <label for="profile" class="col-md-4 col-form-label text-md-right">{{ __('Date of Birth') }}</label>

                            <div class="col-md-6">
                                

                                @if ("/storage/uploads/{{ $user->profile }}")
                                    <img src="{{ asset('storage/uploads/'.$user->profile) }}" height="50px" width="50px">
                                @else
                                    <p>No image found</p>
                                @endif

                                <input id="profile" type="file" class="form-control @error('profile') is-invalid @enderror" name="profile" value="{{ $user->profile }}" required autocomplete="profile" autofocus>
